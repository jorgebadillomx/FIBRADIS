...
builder.Services.AddSingleton<DocumentPipelineMetricsCollector>();
builder.Services.AddSingleton<IReportsDiscoveryMetricsCollector>(sp => sp.GetRequiredService<DocumentPipelineMetricsCollector>());
builder.Services.AddSingleton<IDocumentDownloadMetricsCollector>(sp => sp.GetRequiredService<DocumentPipelineMetricsCollector>());
builder.Services.AddSingleton<IDocumentParseMetricsCollector>(sp => sp.GetRequiredService<DocumentPipelineMetricsCollector>());
builder.Services.AddSingleton<IDocumentFactsPipelineMetricsCollector>(sp => sp.GetRequiredService<DocumentPipelineMetricsCollector>());
...
builder.Services.AddSingleton<IDocumentClassifier, DocumentClassifierService>();
builder.Services.AddSingleton<IDocumentParser, DocumentParserService>();
builder.Services.AddSingleton<IFactsExtractor, DocumentFactsExtractionService>();
builder.Services.AddSingleton<IDocumentDiscoveryService, InMemoryDocumentDiscoveryService>();
builder.Services.AddSingleton<IRobotsPolicy, PermissiveRobotsPolicy>();
builder.Services.AddHttpClient<DocumentDownloadService>();
builder.Services.AddSingleton<IDocumentDownloader>(sp => sp.GetRequiredService<DocumentDownloadService>());
...
builder.Services.AddSingleton<InMemoryAuditService>();
...
builder.Services.AddSingleton<IAdminUserStore>(sp => sp.GetRequiredService<InMemoryUserStore>());
builder.Services.AddSingleton<ISystemSettingsStore, InMemorySystemSettingsStore>();
